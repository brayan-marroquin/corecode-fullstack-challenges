  ...
  render() {
    return (
      <div>
          ...
          <button type="button" id="decrement" onClick={() => this.setState({ counter: this.state.counter - 1 })}>
            Decrement
          </button>
          <button type="button" id="increment" onClick={() => this.setState({ counter: this.state.counter + 1 })}>
            Increment
          </button>
      </div>
    )
